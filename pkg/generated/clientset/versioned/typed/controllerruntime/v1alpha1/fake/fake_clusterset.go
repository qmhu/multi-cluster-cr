...
type FakeClusterSets struct {
	Fake *FakeControllerruntimeV1alpha1
	ns   string
}

var clustersetsResource = schema.GroupVersionResource{Group: "controllerruntime.clusternet.io", Version: "v1alpha1", Resource: "clustersets"}

var clustersetsKind = schema.GroupVersionKind{Group: "controllerruntime.clusternet.io", Version: "v1alpha1", Kind: "ClusterSet"}
