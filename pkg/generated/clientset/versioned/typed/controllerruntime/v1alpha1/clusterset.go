...
import (
	...
	scheme "qmhu/multi-cluster-cr/pkg/generated/clientset/versioned/scheme"
	"time"
...
func newClusterSets(c *ControllerruntimeV1alpha1Client, namespace string) *clusterSets {
	return &clusterSets{
		client: c.RESTClient(),
		ns:     namespace,
	}
